...
CREATE TABLE IF NOT EXISTS `events` (
  ...
  CONSTRAINT `events_ibfk_4` FOREIGN KEY (`package_id`) REFERENCES `event_package` (`type_package_id`) ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

-- Dumping data for table evotick.events: ~0 rows (approximately)
...
-- Dumping data for table evotick.event_package: ~0 rows (approximately)
...
-- Dumping data for table evotick.event_status: ~0 rows (approximately)
...
-- Dumping data for table evotick.event_type: ~0 rows (approximately)
...
CREATE TABLE IF NOT EXISTS `tickets` (
  ...
  CONSTRAINT `tickets_ibfk_2` FOREIGN KEY (`checked_in_by`) REFERENCES `admin` (`admin_id`) ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

-- Dumping data for table evotick.tickets: ~1 rows (approximately)
...
-- Dumping data for table evotick.transactions: ~1 rows (approximately)
