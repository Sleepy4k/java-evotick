<%-- 
    Document   : kategoriSeminar
    Created on : Jun 10, 2025, 7:15:05 AM
    Author     : Pandu
--%>
    ...
    <body class="index-page">
        ...
        <main class="container mt-5 pt-5">
            <section class="text-center my-5">
                <h1>🎓 Event Seminar</h1>
                <p class="lead">Upgrade wawasanmu lewat seminar-seminar inspiratif!</p>
            </section>

            <section class="row row-cols-1 row-cols-md-3 g-4">
                <c:forEach var="data" items="${seminars}">
                    <div class="col">
                        <div class="card h-100 shadow">
                            ...
                            <div class="card-body">
                                ...
                                <a href="${baseUrl}/event/detail?id=${event.id}" class="btn btn-warning w-100">Lihat Detail</a>
                            </div>
                        </div>
                    </div>
                </c:forEach>
