<%-- 
    Document   : adminPackage
    Created on : Jun 10, 2025, 10:50:03 PM
    Author     : Pandu
--%>
                ...
                <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 main-content">
                    <div class="header">
                        <div
                            ...
                            >
                            <h1 class="h2">Manajemen Paket Acara</h1>
                            <div class="btn-toolbar mb-2 mb-md-0">
                                <button
                                    class="btn btn-primary btn-pulse"
                                    data-bs-toggle="modal"
                                    data-bs-target="#addPackageModalLabel"
                                    >
                                    <i class="fas fa-plus me-1"></i> Tambahkan Paket
                                </button>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="table-container">
                        <table
                            ...
                            <tbody>
                                <c:forEach var="data" items="${packages}" varStatus="loop">
                                    <tr>
                                        <td>${loop.index + 1}</td>
